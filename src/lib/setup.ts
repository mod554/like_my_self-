// Shared setup logic called from instrumentation.ts on server startup
// All operations are idempotent (IF NOT EXISTS / findUnique before create)
...
export async function runMigrate(): Promise<void> {
  ...
  console.log("[setup] migrate: tables created/verified");
}
